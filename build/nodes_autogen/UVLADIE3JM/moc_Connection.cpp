...
void QtNodes::Connection::qt_static_metacall(QObject *_o, QMetaObject::Call _c, int _id, void **_a)
{
    if (_c == QMetaObject::InvokeMetaMethod) {
        ...
        {
            typedef void (Connection::*_t)(Connection & ) const;
            if (*reinterpret_cast<_t *>(func) == static_cast<_t>(&Connection::updated)) {
                *result = 0;
                return;
            }
        }
...
const QMetaObject QtNodes::Connection::staticMetaObject = {
    { &QObject::staticMetaObject, qt_meta_stringdata_QtNodes__Connection.data,
      qt_meta_data_QtNodes__Connection,  qt_static_metacall, Q_NULLPTR, Q_NULLPTR}
};
...
void *QtNodes::Connection::qt_metacast(const char *_clname)
{
    ...
    if (!strcmp(_clname, "Serializable"))
        return static_cast< Serializable*>(const_cast< Connection*>(this));
