...
NodeGeometry::NodeGeometry(std::unique_ptr<NodeDataModel> const &dataModel)  : _width(100)
                                                                            , _height(150)
                                                                            , _inputPortWidth(70)
                                                                            , _outputPortWidth(70)
                                                                            , _entryHeight(20)
...
QPointF NodeGeometry::portScenePosition(int index, PortType portType, QTransform t) const {
  auto const &nodeStyle = StyleCollection::nodeStyle();
...
PortIndex NodeGeometry::checkHitScenePoint(PortType portType,
...
QPointF NodeGeometry::calculateNodePositionBetweenNodePorts(PortIndex targetPortIndex,
                                      PortType targetPort, Node* targetNode,
