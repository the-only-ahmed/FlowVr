...
const QMetaObject QtNodes::NodeGraphicsObject::staticMetaObject = {
    { &QGraphicsObject::staticMetaObject, qt_meta_stringdata_QtNodes__NodeGraphicsObject.data,
      qt_meta_data_QtNodes__NodeGraphicsObject,  qt_static_metacall, Q_NULLPTR, Q_NULLPTR}
};
...
void *QtNodes::NodeGraphicsObject::qt_metacast(const char *_clname)
{
    ...
    if (!strcmp(_clname, qt_meta_stringdata_QtNodes__NodeGraphicsObject.stringdata0))
        return static_cast<void*>(const_cast< NodeGraphicsObject*>(this));
