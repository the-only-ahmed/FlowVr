...
#include "../../../../reactSrc/ImageLoaderModel.hpp"
...
const QMetaObject ImageLoaderModel::staticMetaObject = {
    { &NodeDataModel::staticMetaObject, qt_meta_stringdata_ImageLoaderModel.data,
      qt_meta_data_ImageLoaderModel,  qt_static_metacall, Q_NULLPTR, Q_NULLPTR}
};
...
void *ImageLoaderModel::qt_metacast(const char *_clname)
{
    ...
    if (!strcmp(_clname, qt_meta_stringdata_ImageLoaderModel.stringdata0))
        return static_cast<void*>(const_cast< ImageLoaderModel*>(this));
