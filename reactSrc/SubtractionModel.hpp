...
public:
  ...
  virtual bool  portCaptionVisible(PortType portType, PortIndex portIndex) const override  { return true; }
  ...
  std::unique_ptr<NodeDataModel>  clone() const override  { return std::make_unique<SubtractionModel>(); }
