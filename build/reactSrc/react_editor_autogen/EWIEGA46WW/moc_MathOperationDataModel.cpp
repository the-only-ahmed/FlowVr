...
#include "../../../../reactSrc/MathOperationDataModel.hpp"
...
const QMetaObject MathOperationDataModel::staticMetaObject = {
    { &NodeDataModel::staticMetaObject, qt_meta_stringdata_MathOperationDataModel.data,
      qt_meta_data_MathOperationDataModel,  qt_static_metacall, Q_NULLPTR, Q_NULLPTR}
};
...
void *MathOperationDataModel::qt_metacast(const char *_clname)
{
    ...
    if (!strcmp(_clname, qt_meta_stringdata_MathOperationDataModel.stringdata0))
        return static_cast<void*>(const_cast< MathOperationDataModel*>(this));
