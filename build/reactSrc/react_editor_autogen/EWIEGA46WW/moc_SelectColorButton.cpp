/****************************************************************************
** Meta object code from reading C++ file 'SelectColorButton.hpp'
**
...
#include "../../../../reactSrc/SelectColorButton.hpp"
#include <QtCore/qbytearray.h>
#include <QtCore/qmetatype.h>
#if !defined(Q_MOC_OUTPUT_REVISION)
#error "The header file 'SelectColorButton.hpp' doesn't include <QObject>."
...
#define QT_MOC_LITERAL(idx, ofs, len) \
    ...
    qptrdiff(offsetof(qt_meta_stringdata_SelectColorButton_t, stringdata0) + ofs \
        - idx * sizeof(QByteArrayData)) \
    )
static const qt_meta_stringdata_SelectColorButton_t qt_meta_stringdata_SelectColorButton = {
    {
QT_MOC_LITERAL(0, 0, 17), // "SelectColorButton"
QT_MOC_LITERAL(1, 18, 11), // "updateColor"
QT_MOC_LITERAL(2, 30, 0), // ""
QT_MOC_LITERAL(3, 31, 11) // "changeColor"
...
void SelectColorButton::qt_static_metacall(QObject *_o, QMetaObject::Call _c, int _id, void **_a)
{
    if (_c == QMetaObject::InvokeMetaMethod) {
        SelectColorButton *_t = static_cast<SelectColorButton *>(_o);
        Q_UNUSED(_t)
        switch (_id) {
...
const QMetaObject SelectColorButton::staticMetaObject = {
    { &QPushButton::staticMetaObject, qt_meta_stringdata_SelectColorButton.data,
      qt_meta_data_SelectColorButton,  qt_static_metacall, Q_NULLPTR, Q_NULLPTR}
};
...
void *SelectColorButton::qt_metacast(const char *_clname)
{
    ...
    if (!strcmp(_clname, qt_meta_stringdata_SelectColorButton.stringdata0))
        return static_cast<void*>(const_cast< SelectColorButton*>(this));
