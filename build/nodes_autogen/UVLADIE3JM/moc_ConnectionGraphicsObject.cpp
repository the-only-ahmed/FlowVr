...
#include "../../../src/ConnectionGraphicsObject.hpp"
...
const QMetaObject QtNodes::ConnectionGraphicsObject::staticMetaObject = {
    { &QGraphicsObject::staticMetaObject, qt_meta_stringdata_QtNodes__ConnectionGraphicsObject.data,
      qt_meta_data_QtNodes__ConnectionGraphicsObject,  qt_static_metacall, Q_NULLPTR, Q_NULLPTR}
};
...
void *QtNodes::ConnectionGraphicsObject::qt_metacast(const char *_clname)
{
    ...
    if (!strcmp(_clname, qt_meta_stringdata_QtNodes__ConnectionGraphicsObject.stringdata0))
        return static_cast<void*>(const_cast< ConnectionGraphicsObject*>(this));
